...
if __name__ == '__main__':
    ...
    config = x.Config()  # 进入到对应模型的__init__方法进行参数初始化
    ...
    vocab_targ_size = len(tokenizer.word_index) + 1
    ...
    def evaluate(sentence):
        ...
        # sentence = add_BOS_EOS(sentence)
        words = sentence.strip()
        sentence = 'bos ' + words + ' eos'
        ...
        dec_input = tf.expand_dims([tokenizer.word_index['bos']], 0)
